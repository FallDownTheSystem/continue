              ...
              if (Array.isArray(message.content) && message.content.length > 0) {
                ...
                for (const part of message.content) {
                  if (part.type === "thinking") {
                    ...
                    lastItem.reasoning.text = "[Some thinking content has been redacted for safety reasons]";
                    ...
                    if (typeof lastMessage.content === "string" && lastMessage.content.length > 0) {
                      ...
                      if (textPart && textPart.type === "text") {
                        ...
                        lastMessage.content.push({ type: "text", text: part.text });
                      }
                    } else {
                ...
                if (fullContent.includes("<think>") && fullContent.includes("</think>")) {
                  ...
                  const thinkMatches = fullContent.match(/<think>(.*?)<\/think>/s);
